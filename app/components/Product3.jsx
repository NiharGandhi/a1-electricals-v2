        ...
        <>
            <div className="relative flex flex-col lg:flex-row bg-white lg:mb-[700px]">
                ...
                <div className="lg:w-1/2 relative">
                    ...
                    <Image src={Cleats} alt="Cable Lug" className="hidden sm:block w-full h-auto mt-[-150px] lg:mt-[160px] absolute top-0 left-0 z-0 " />
                    ...
                    <Image src={Cleats} alt="Cable Lug" width={400} height={400} className="mt-[-270px] top-0 left-0 lg:hidden -z-10" />
                </div>
