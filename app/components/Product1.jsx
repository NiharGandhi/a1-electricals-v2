...
import Gland from "../../public/assets/gland.png";
            ...
            <div className="relative flex flex-col lg:flex-row bg-white lg:mb-[700px]">
                <div className="lg:w-1/2 relative bg-white">
                    ...
                    <div className="absolute text-center items-center justify-center z-10">
                        <h1 className="text-center text-2xl md:text-lg lg:text-6xl leading-tight font-bold px-4 mt-[20px] lg:mt-[100px] lg:px-12 text-orange-500">
                            INDUSTRIAL BRASS CABLE GLANDS & ACCESSORIES
                        </h1>
                ...
                <div className="lg:w-1/2 relative">
                    ...
                    <Image src={Gland} alt="Cable Lug" className="hidden sm:block w-full h-auto mt-[-150px] lg:mt-[160px] absolute top-0 left-0 z-0 " />
                    ...
                    <Image src={Gland} alt="Cable Lug" width={400} height={400} className="mt-[-270px] top-0 left-0 lg:hidden -z-10" />
                </div>
